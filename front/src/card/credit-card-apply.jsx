...
class CreditCardApply extends Component {
    state = { 
        passWord: "",
    } 
    loginSubmit = (e) => {
        e.preventDefault();
        $.ajax({
            url: `${APIHOST}${APIPATH.creditApply}`,
            type: "post",
            data: JSON.stringify({
                    ...
                    <div className='col-md-8 text-center m-auto'>
                        ...
                        <form>
                            ...
                            <div className="text-center">
                                <button onClick={e => this.loginSubmit(e)} className="btn btn-primary mx-2" id="submitBotton">开卡！</button>
                            </div>
                        </form>
                    </div>
                </div>
...
export default connect(mapStateToProps)(CreditCardApply);