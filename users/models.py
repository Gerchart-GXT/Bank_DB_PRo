...
class Client(models.Model):
    ...
    client_idnum = models.CharField(max_length=18, null=False, verbose_name="客户身份证号")
    client_phone_number = models.CharField(max_length=11, null=False, verbose_name="客户电话号码")
    client_email_address = models.CharField(max_length=100, null=False, verbose_name="客户邮箱")
...
class Credit_card(models.Model):
    ...
    card_balance = models.DecimalField(max_digits=18, decimal_places=2, default=0, null=False,
                                       verbose_name="信用卡余额")
    card_credit_limit = models.DecimalField(max_digits=18, decimal_places=2, default=0, null=False,
                                            verbose_name="信用卡额度")
...
class Manager(models.Model):
    ...
    manager_phone_number = models.CharField(max_length=20, null=False, verbose_name="经理电话号码")
    manager_email_address = models.CharField(max_length=100, null=False, verbose_name="经理邮箱")
...
class Currency_project(models.Model):
    ...
    manager_id = models.ForeignKey(Manager, on_delete=models.CASCADE, null=False, verbose_name="项目所属经理编号")
...
class Insurance_project(models.Model):
    ...
    insurance_policyholder = models.CharField(max_length=20, null=False, verbose_name="投保人身份证号")
    insurance_insured = models.CharField(max_length=20, null=False, verbose_name="被保人身份证号")
    insurance_amount = models.DecimalField(max_digits=18, decimal_places=2, null=False, default=0,
                                           verbose_name="投保金额")
...
class Fund_project(models.Model):
    ...
    fund_amount = models.DecimalField(max_digits=18, decimal_places=2, null=False, default=0, verbose_name="基金金额")
    fund_income = models.DecimalField(max_digits=18, decimal_places=2, null=False, default=0, verbose_name="基金收益")
...
class Financial_project(models.Model):
    ...
    financial_project_amount = models.DecimalField(max_digits=18, decimal_places=2, null=False, default=0,
                                                   verbose_name="理财项目金额")
    financial_project_income = models.DecimalField(max_digits=18, decimal_places=2, null=False, default=0,
                                                   verbose_name="理财项目收益")
