# Generated by Django 4.2.2 on 2023-06-21 01:12
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            name='Credit_card',
            fields=[
                ('card_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, primary_key=True, serialize=False, to='bank.card', verbose_name='信用卡对应卡片id')),
        ...
        migrations.CreateModel(
            name='Debit_card',
            fields=[
                ('card_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, primary_key=True, serialize=False, to='bank.card', verbose_name='借记卡对应卡片id')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('project_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, primary_key=True, serialize=False, to='bank.currency_project', verbose_name='项目编号')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('fund_type', models.IntegerField(choices=[(1, 'A基金'), (2, 'B基金'), (3, 'C基金')], verbose_name='基金类型')),
        ...
        migrations.AddField(
            model_name='currency_project',
            name='department_id',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='bank.department', verbose_name='项目所属部门编号'),
        ),
        migrations.AddField(
            model_name='card',
            name='client_id',
